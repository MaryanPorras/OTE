...
#There are two functions, in the first we are integrating from the lower bound to
#the upper bound (normal integration), while in the other one we are integrating in
#reverse (from the upper bound to the lower bound).
